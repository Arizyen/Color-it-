...
local function CustomButton(props: props)
	...
	return e(
		"TextButton",
		Utils.Table.MergeProps({
			ref = buttonRef,
			Size = (props.noButtonAnimation ~= nil and not props.noButtonAnimation) and props.Size
			...
			[React.Event.MouseEnter] = function()
				if props.noButtonAnimation == nil or props.noButtonAnimation ~= false then
